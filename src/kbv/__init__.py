"""
Kalman-Bayesian Volatility Filtering Package

A comprehensive framework for filtering and estimating latent volatility
in financial time series using state-space models.
"""
